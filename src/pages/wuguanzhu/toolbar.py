...
class Toolbar(QWidget):
    def __init__(self, model, dispatch, parent=None):
        ...
        self.bts[8].setCallBack(dispatch.imagePanel.retinaSeg)
        self.bts[9].setCallBack(dispatch.imagePanel.rectRatio)
        self.bts[10].setCallBack(dispatch.imagePanel.undo)
        self.bts[11].setCallBack(dispatch.imagePanel.saveData)
        self.bts[12].setCallBack(dispatch.imagePanel.saveMask)
