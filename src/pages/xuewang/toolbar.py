...
class Toolbar(QWidget):
    def __init__(self, model, dispatch, parent=None):
        ...
        self.bts[8].setCallBack(dispatch.imagePanel.undo)
        self.bts[9].setCallBack(dispatch.imagePanel.saveData)
        self.bts[10].setCallBack(dispatch.imagePanel.saveMask)
